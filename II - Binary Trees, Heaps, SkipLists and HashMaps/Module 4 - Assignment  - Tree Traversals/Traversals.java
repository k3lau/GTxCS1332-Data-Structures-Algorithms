...
public class Traversals<T extends Comparable<? super T>> {
  ...
  private void preorderHelper(List<T> list, TreeNode<T> currentNode) {
    if (currentNode != null) {
  ...
  private void inorderHelper(List<T> list, TreeNode<T> currentNode) {
    if (currentNode != null) {
  ...
  private void postorderHelper(List<T> list, TreeNode<T> currentNode) {
    if (currentNode != null) {
